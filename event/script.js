...
// show a message when mouse is over the button
...
// hide the message when mouse is out of the button
...
// hide the button on double-click
function hideButton(event) {
    event.target.style.display = 'none';
}

// event listeners in all buttons
